...
import pnj.pk.musikplayerpk.Adapter.ViewPagerAdapter;
import pnj.pk.musikplayerpk.DB.FavoritesOperations;
...
import pnj.pk.musikplayerpk.Model.SongsList;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    ...
    private void about() {
        ...
        builder.setTitle("about")
                .setMessage("SF Musik Merupakan Aplikasi musik yang dibuat oleh mahasiswa PNJ")
